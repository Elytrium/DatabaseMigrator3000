...
public class MySQLDeleteOnCloseConnection implements Connection {
  ...
  public MySQLDeleteOnCloseConnection(Connection connection, Connection rootConnection, String username, String password, String database) {
